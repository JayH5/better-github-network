...
class Table
{
  ...
  void setRepo(String repo_name, List<Integer> activity_list)
  {
    MAIN_REPO = new Row(repo_name, activity_list);
  }
  
  void addRow(String fork_name, List<Integer> activity_list)
  {
    rowList.add(new Row(fork_name, activity_list));
  }
...
//       fill(255,255,255);
  ...
  class Row
  {
    ...
    Row(String name_, List<Integer> acitivitylist)
    {
      name = name_; 
      acitivityList = acitivitylist;
